...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_CHECK_TIMER:
            ...
            /***************/
            if (appData.isReadComplete || gotRx || _CP0_GET_COUNT() - startTime > (48000000 / 2 / 5)) {
                appData.state = APP_STATE_SCHEDULE_WRITE;
            }
            /**************/
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            if (appData.isReadComplete || gotRx) {
                OC1RS = 500;
               /****************/
             if (gotRx) {
                gotRx = 0;
                ...
                */
                ...
                OC1RS = 900 + rxVal; // velocity, 50%
                LATBbits.LATB3 = 1; // direction
                OC4RS = 900 - rxVal; // velocity, 50%
                }
                */
                ...
                switch(rxVal){
                    ...
                    case 2:
                        LATAbits.LATA1 = 1; // direction
                        OC1RS = 500; // velocity, 50%
                        LATBbits.LATB3 = 1; // direction
                        OC4RS = 800; // velocity, 50%
                        break;
                    case 22:
                        LATAbits.LATA1 = 1; // direction
                        OC1RS = 100; // velocity, 50%
                        LATBbits.LATB3 = 1; // direction
                        OC4RS = 800; // velocity, 50%
                        break;
                    case 3:
                        LATAbits.LATA1 = 1; // direction
                        OC1RS = 800; // velocity, 50%
                        LATBbits.LATB3 = 1; // direction
                        OC4RS = 500; // velocity, 50%
                        break;
                    case 33:
                        LATAbits.LATA1 = 1; // direction
                        OC1RS = 800; // velocity, 50%
                        LATBbits.LATB3 = 1; // direction
                        OC4RS = 100; // velocity, 50%
                        break;
                    case 4:
                        LATAbits.LATA1 = 0; // direction
                        OC1RS = 700; // velocity, 50%
                        LATBbits.LATB3 = 0; // direction
                        OC4RS = 700; // velocity, 50%
                        break;
                    case 44:
                        LATAbits.LATA1 = 1; // direction
                        OC1RS = 900; // velocity, 50%
                        LATBbits.LATB3 = 1; // direction
                        OC4RS = 900; // velocity, 50%
                        break;
                    case 0:
                        LATAbits.LATA1 = 0; // direction
                        OC1RS = 0; // velocity, 50%
